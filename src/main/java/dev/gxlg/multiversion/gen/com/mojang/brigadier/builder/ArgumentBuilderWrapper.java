...
public class ArgumentBuilderWrapper extends R.RWrapper<ArgumentBuilderWrapper> {
    ...
    public dev.gxlg.multiversion.gen.com.mojang.brigadier.builder.ArgumentBuilderWrapper then(dev.gxlg.multiversion.gen.com.mojang.brigadier.builder.ArgumentBuilderWrapper argument){
        return dev.gxlg.multiversion.gen.com.mojang.brigadier.builder.ArgumentBuilderWrapper.inst(clazz.inst(this.instance).mthd("then", dev.gxlg.multiversion.gen.com.mojang.brigadier.builder.ArgumentBuilderWrapper.clazz.self(), dev.gxlg.multiversion.gen.com.mojang.brigadier.builder.ArgumentBuilderWrapper.clazz.self()).invk(argument.unwrap()));
    }
    ...
    public dev.gxlg.multiversion.gen.com.mojang.brigadier.builder.ArgumentBuilderWrapper executes(com.mojang.brigadier.Command command){
        return dev.gxlg.multiversion.gen.com.mojang.brigadier.builder.ArgumentBuilderWrapper.inst(clazz.inst(this.instance).mthd("executes", dev.gxlg.multiversion.gen.com.mojang.brigadier.builder.ArgumentBuilderWrapper.clazz.self(), com.mojang.brigadier.Command.class).invk(command));
    }
