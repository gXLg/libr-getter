...
public class MultiPlayerGameModeWrapper extends R.RWrapper<MultiPlayerGameModeWrapper> {
    ...
    public net.minecraft.world.InteractionResult useItemOn(net.minecraft.client.player.LocalPlayer player, net.minecraft.world.InteractionHand hand, net.minecraft.world.phys.BlockHitResult hit){
        return (net.minecraft.world.InteractionResult) this.instance.mthd("method_2896/useItemOn", net.minecraft.client.player.LocalPlayer.class, net.minecraft.world.InteractionHand.class, net.minecraft.world.phys.BlockHitResult.class).invk(player, hand, hit);
    }
    ...
    public net.minecraft.world.InteractionResult useItemOn(net.minecraft.client.player.LocalPlayer player, net.minecraft.client.multiplayer.ClientLevel clientWorld, net.minecraft.world.InteractionHand hand, net.minecraft.world.phys.BlockHitResult hit){
        return (net.minecraft.world.InteractionResult) this.instance.mthd("method_2896/useItemOn", net.minecraft.client.player.LocalPlayer.class, net.minecraft.client.multiplayer.ClientLevel.class, net.minecraft.world.InteractionHand.class, net.minecraft.world.phys.BlockHitResult.class).invk(player, clientWorld, hand, hit);
    }
