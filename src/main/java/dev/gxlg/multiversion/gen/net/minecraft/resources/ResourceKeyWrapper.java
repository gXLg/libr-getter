...
public class ResourceKeyWrapper extends R.RWrapper<ResourceKeyWrapper> {
    ...
    public static ResourceKeyWrapper inst(Object instance) {
        return instance == null ? null : new ResourceKeyWrapper(instance);
    }

    public static class Interceptor {
        @SuppressWarnings("unused")
        @RuntimeType
        public static Object intercept(@Origin Method method, @FieldValue("__wrapper") ResourceKeyWrapper wrapper, @AllArguments Object[] args, @SuperCall Callable<?> superCall) throws Exception {
