...
public class ItemStackWrapper extends R.RWrapper<ItemStackWrapper> {
    ...
    public dev.gxlg.multiversion.gen.net.minecraft.nbt.CompoundTagWrapper getTag(){
        return dev.gxlg.multiversion.gen.net.minecraft.nbt.CompoundTagWrapper.inst(clazz.inst(this.instance).mthd("method_7969/getTag").invk());
    }

    public dev.gxlg.multiversion.gen.net.minecraft.world.item.enchantment.ItemEnchantmentsWrapper getEnchantments(){
        return dev.gxlg.multiversion.gen.net.minecraft.world.item.enchantment.ItemEnchantmentsWrapper.inst(clazz.inst(this.instance).mthd("method_58657/getEnchantments").invk());
    }
