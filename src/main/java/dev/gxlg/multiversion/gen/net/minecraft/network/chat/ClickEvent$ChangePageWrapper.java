...
public class ClickEvent$ChangePageWrapper extends dev.gxlg.multiversion.gen.net.minecraft.network.chat.ClickEventWrapper {
    ...
    public static ClickEvent$ChangePageWrapper inst(Object instance) {
        return instance == null ? null : new ClickEvent$ChangePageWrapper(instance);
    }

    public static class Interceptor {
        @SuppressWarnings("unused")
        @RuntimeType
        public static Object intercept(@Origin Method method, @FieldValue("__wrapper") ClickEvent$ChangePageWrapper wrapper, @AllArguments Object[] args, @SuperCall Callable<?> superCall) throws Exception {
