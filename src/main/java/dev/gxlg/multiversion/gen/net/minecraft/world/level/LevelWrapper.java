...
public class LevelWrapper extends R.RWrapper<LevelWrapper> {
    ...
    public void playLocalSound(double x, double y, double z, net.minecraft.sounds.SoundEvent sound, net.minecraft.sounds.SoundSource source, float volume, float pitch, boolean distanceDelay){
        this.instance.mthd("method_8486/playLocalSound", double.class, double.class, double.class, net.minecraft.sounds.SoundEvent.class, net.minecraft.sounds.SoundSource.class, float.class, float.class, boolean.class).invk(x, y, z, sound, source, volume, pitch, distanceDelay);
    }
