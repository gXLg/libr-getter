...
public class HolderWrapper extends R.RWrapper<HolderWrapper> {
    ...
    public boolean is(dev.gxlg.multiversion.gen.net.minecraft.resources.ResourceKeyWrapper resourceKey){
        return (boolean) clazz.inst(this.instance).mthd("method_40225/is", dev.gxlg.multiversion.gen.net.minecraft.resources.ResourceKeyWrapper.clazz).invk(resourceKey.unwrap());
    }

    public boolean is(dev.gxlg.multiversion.gen.net.minecraft.tags.TagKeyWrapper resourceKey){
        return (boolean) clazz.inst(this.instance).mthd("method_40220/is", dev.gxlg.multiversion.gen.net.minecraft.tags.TagKeyWrapper.clazz).invk(resourceKey.unwrap());
    }

    public String getRegisteredName(){
        return (String) clazz.inst(this.instance).mthd("method_55840/getRegisteredName").invk();
    }
