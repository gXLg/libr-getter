...
public class VillagerDataWrapper extends R.RWrapper<VillagerDataWrapper> {
    ...
    public dev.gxlg.multiversion.gen.net.minecraft.core.HolderWrapper profession(){
        return dev.gxlg.multiversion.gen.net.minecraft.core.HolderWrapper.inst(this.instance.mthd("comp_3521/profession").invk());
    }

    public dev.gxlg.multiversion.gen.net.minecraft.world.entity.npc.villager.VillagerProfessionWrapper getProfession(){
        return dev.gxlg.multiversion.gen.net.minecraft.world.entity.npc.villager.VillagerProfessionWrapper.inst(this.instance.mthd("method_16924/getProfession").invk());
    }
