...
public class HoverEventWrapper extends R.RWrapper<HoverEventWrapper> {
    ...
    public HoverEventWrapper(dev.gxlg.librgetter.multiversion.gen.net.minecraft.network.chat.HoverEvent$ActionWrapper action, Object contents) {
        this(clazz.constr(dev.gxlg.librgetter.multiversion.gen.net.minecraft.network.chat.HoverEvent$ActionWrapper.clazz, Object.class).newInst(action.unwrap(), contents).self());
    }
