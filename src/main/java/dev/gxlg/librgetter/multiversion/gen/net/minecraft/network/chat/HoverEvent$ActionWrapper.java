...
public class HoverEvent$ActionWrapper extends R.RWrapper<HoverEvent$ActionWrapper> {
    ...
    public static dev.gxlg.librgetter.multiversion.gen.net.minecraft.network.chat.HoverEvent$ActionWrapper SHOW_TEXT() {
        return dev.gxlg.librgetter.multiversion.gen.net.minecraft.network.chat.HoverEvent$ActionWrapper.inst(clazz.fld("field_24342/SHOW_TEXT").get());
    }
}
