...
public class ClickEventWrapper extends R.RWrapper<ClickEventWrapper> {
    ...
    public ClickEventWrapper(dev.gxlg.librgetter.multiversion.gen.net.minecraft.network.chat.ClickEvent$ActionWrapper action, String value) {
        this(clazz.constr(dev.gxlg.librgetter.multiversion.gen.net.minecraft.network.chat.ClickEvent$ActionWrapper.clazz, String.class).newInst(action.unwrap(), value).self());
    }
