package dev.gxlg.librgetter.multiversion.gen.net.fabricmc.fabric.api.client.command.v1;
...
public class ClientCommandManagerWrapper extends R.RWrapper<ClientCommandManagerWrapper> {
    ...
    public static dev.gxlg.librgetter.multiversion.gen.com.mojang.brigadier.CommandDispatcherWrapper DISPATCHER() {
        return dev.gxlg.librgetter.multiversion.gen.com.mojang.brigadier.CommandDispatcherWrapper.inst(clazz.fld("DISPATCHER").get());
    }
