...
public class RegistryWrapper extends R.RWrapper<RegistryWrapper> {
    ...
    public dev.gxlg.librgetter.multiversion.gen.net.minecraft.resources.ResourceKeyWrapper key() {
         return dev.gxlg.librgetter.multiversion.gen.net.minecraft.resources.ResourceKeyWrapper.inst(instance.mthd("method_30517/key").invk());
    }
