...
import dev.gxlg.librgetter.multiversion.gen.net.minecraft.network.chat.ClickEvent$ChangePageWrapper;
import dev.gxlg.librgetter.multiversion.gen.net.minecraft.network.chat.ClickEvent$RunCommandWrapper;
import dev.gxlg.librgetter.multiversion.gen.net.minecraft.network.chat.ComponentWrapper;
import dev.gxlg.librgetter.multiversion.gen.net.minecraft.network.chat.HoverEvent$ShowTextWrapper;
