...
public class Parser {
    private static CompoundTagWrapper getCustomData(ItemStack stack) {
    ...
    private static EnchantmentTrade.EnchantmentOnly parseStored(ItemStack stack) {
        if (!V.lower("1.20.5")) {
    ...
    private static EnchantmentTrade.EnchantmentOnly fallbackParse(Object tag) {
