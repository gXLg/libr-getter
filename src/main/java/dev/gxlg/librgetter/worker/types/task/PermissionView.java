...
public record PermissionView(
    boolean allowsBreakingLecterns, boolean allowsPlacingLectern, boolean allowsSettingTradeOffers, boolean allowsOpeningScreen, boolean forcesSecondaryUse, boolean disablesBlockBreakStopping
) {
