...
<img alt="Clientside badge" src="https://img.shields.io/endpoint?url=https%3A%2F%2Fgxlg.github.io%2Fbadges%2Fclientside.json" align="center">&nbsp;
...
With Trade Cycling ([<kbd>Modrinth</kbd>](https://modrinth.com/mod/trade-cycling)) installed on the server, instead of replacing the lectern, LibrGetter will push the cycling button, until an enchantment is found.
